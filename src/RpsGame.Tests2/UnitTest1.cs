...
namespace RpsGame.Tests2
{
  public class UnitTest1
  {
    ...
    [InlineData(ThrowChoice.Lizard, ThrowChoice.Rock, Outcome.Player2Wins)]
    [InlineData(ThrowChoice.Spock, ThrowChoice.Rock, Outcome.Player1Wins)]
    ...
    [InlineData(ThrowChoice.Lizard, ThrowChoice.Paper, Outcome.Player1Wins)]
    [InlineData(ThrowChoice.Spock, ThrowChoice.Paper, Outcome.Player2Wins)]
    ...
    [InlineData(ThrowChoice.Lizard, ThrowChoice.Scissors, Outcome.Player2Wins)]
    [InlineData(ThrowChoice.Spock, ThrowChoice.Scissors, Outcome.Player1Wins)]

    [InlineData(ThrowChoice.Rock, ThrowChoice.Lizard, Outcome.Player1Wins)]
    [InlineData(ThrowChoice.Paper, ThrowChoice.Lizard, Outcome.Player2Wins)]
    [InlineData(ThrowChoice.Scissors, ThrowChoice.Lizard, Outcome.Player1Wins)]
    [InlineData(ThrowChoice.Lizard, ThrowChoice.Lizard, Outcome.Tie)]
    [InlineData(ThrowChoice.Spock, ThrowChoice.Lizard, Outcome.Player2Wins)]
    [InlineData(ThrowChoice.Rock, ThrowChoice.Spock, Outcome.Player2Wins)]
    [InlineData(ThrowChoice.Paper, ThrowChoice.Spock, Outcome.Player1Wins)]
    [InlineData(ThrowChoice.Scissors, ThrowChoice.Spock, Outcome.Player2Wins)]
    [InlineData(ThrowChoice.Lizard, ThrowChoice.Spock, Outcome.Player1Wins)]
    [InlineData(ThrowChoice.Spock, ThrowChoice.Spock, Outcome.Tie)]
